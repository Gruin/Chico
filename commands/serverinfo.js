...
exports.run = async (client, message, args) => {
    ...
    .setColor("#6400b6")
    .setTitle(message.guild.name + ` Status do server:`)
    ...
    .addField(`:pencil:  ID do dono do server`, message.guild.ownerID, true)
    .addField(':date: Server Criado em', message.guild.createdAt, true)
    .addField(`:closed_lock_with_key: Nível de verificação do server:`, message.guild.verificationLevel, true)
