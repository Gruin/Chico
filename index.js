...
bot.on('message', message => {
  ...
  try {
    ...
    .setColor('GREEN')
    .setDescription(`${message.author}, esse comando não existe no meu código, \nUtilize **.help** para saber quais comandos estão disponíveis`)
...
bot.on('ready', () => {
  ...
  var tabela = [
    { name: 'kkkkkkkkkkkkkkkkk', type: 'PLAYING' },
    { name: 'aff', type: 'WATCHING' }
  ];
